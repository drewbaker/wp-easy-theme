...
class Override {
	...
	public function init() {
		...
		// Init TGM.
		require_once Utils::get_template_directory( 'includes/libs/class-tgm-plugin-activation.php' );
		add_action( 'tgmpa_register', array( $this, 'register_required_plugins' ) );

		// Init NoCommentsPlease.
		require_once Utils::get_template_directory( 'includes/libs/no-comments-please.php' );
	}
